...
![GKE&#xD074;&#xB7EC;&#xC2A4;&#xD130; &#xC0DD;&#xC131;&#xD558;&#xAE30;](../../.gitbook/assets/image%20%2813%29.png)
...
### **Task1.**  GKE Cluster **CLI 접근하기**

GKE cluster 메뉴에서 Connect 메뉴를 선택한 다음 ‘Run in Cloud Shell’ 을 클릭하면 됩니다.  
\(로컬 환경의 CloudSDK 사용방법은 아래 링크에서 확인해주세요.\)

![](../../.gitbook/assets/image%20%289%29.png)

### Task2. GKE 기본서비스 실행하기

하단의 kubectl 명령을 통해서 샘플 container 를 GKE cluster 에 배포 합니다.  
여기서 기본 Kubernetes 를 해본 분들도 ‘gcr.io/google-samples/hello-app:1.0’ 라는 부분이 생소할 수 있는데 이건 Google 의 비공개 container 저장소인 Google Container Registry\(GCR\) 의 주소 입니다.  
GCP에서 제공하는 샘플 저장소 내의 hello-app 이라는 이미지의 주소입니다.  
아래 링크를 복사하여 실행합니다.
...
지금 수행한 kubectl 명령은 단순하게 run 을 수행하지만 내부적으로는 Kubernetes 의 deployment 를 생성하게 됩니다.  
아래와 같이 워크로드가 생성된 것을 확인 할 수  있습니다.
...
EXTERNAL-IP가 생성된 것으로 확인 할 수 있으며, 해당 IP로 접근하면 샘플 서비스의 서비스 결과 확인할 수 있습니다.
